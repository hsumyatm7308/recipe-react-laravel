...
import { useSignUpMutation } from "../store/services/endpoints/auth";
...
const SignUp = () => {
  ...
  return (
    <NotAuthGuard>
      <main className="flex items-center justify-center md:space-x-[83px] px-3 w-full h-screen ">
        ...
        <section className=" w-[455px]">
          <div className="flex flex-col items-center  space-y-6 mb-[52px]">
            ...
            <div className=" bg-second h-[60px] rounded-full flex items-center justify-between w-[329px]">
              <Link to="/sign-in" className=" grow text-end  text-main">
                Login
              </Link>
              <Link to="/sign-up">
                <PrimaryBtn className=" rounded-full h-10 w-[146px] hover:bg-main/90 hover:text-white  m-[10px] ml-[56px]">
                  Register
                </PrimaryBtn>
              </Link>
            </div>
          ...
          >
            {({
              ...
              <>
                <Form>
                  {/* email  */}
                  <div className={`${errors.email ? " mb-2" : "mb-[30px]"} `}>
                  ...
                  {/* name  */}
                  <div className={`${errors.name ? " mb-2" : "mb-[30px]"} `}>
                  ...
                  <p className=" text-textGray text-sm tracking-wider mb-[33px]">
